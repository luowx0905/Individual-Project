...
K nearest neighbor (KNN) is one of the classification algorithms for supervised learning, which stores all the training data \citep{RN33}. During forecasting, the distances between input and all the training data are calculated, and the prediction would be the class of the training data closest to the input data. The distinct advantage of this algorithm is that it is simple to implement. In contrast, the disadvantage is obvious; the prediction could be time-consuming due to the computation of the distances to all the training data. 

\subsubsection{Decision Tree}
Decision Tree is another supervised learning algorithm that can be used for classification and regression \citep{RN33}. When training this type of model,  the data is splitted into smaller groups recursively based on information entropy. The split conditions are stored in the each node, and the subsequent conditions are located in the children of each node. One of the benefits of decision tree is that the outliers cannot significantly influence the performance compared to other algorithms, since split conditions generally cause the outliers to be a class by themselves \citep{RN31}.

\subsection{Machine Learning Approaches}
In a similar study to this project, \citet{RN17} devised a reliable method for predicting the prices in Riyadh, Saudi Arabia. The attributes of properties, such as location, area, type, and price, are identical to the dataset in this project. However, the interior layouts and facilities, such as parking spaces, outside areas, and heating, were not covered in their study; hence their dataset was inferior to the one in this project. Furthermore, their study was based on the properties in the Middle East, which is significantly different from the UK in all aspects, including culture and climate, indicating that the results were unlikely to be applicable to the current project. Various models were utilized, including decision tree, random forest, and linear regression. For the evaluation phase, the mean absolute error, mean squared error and median squared error were applied. As a result, the random forest has the best performance among the three algorithms. Future improvements discussed include incorporating more data in Riyadh and considering economic trends as a factor that can influence the prices. In addition, other machine learning models are also encouraged in order to improve performance. 
\\

In another research, \citet{RN20} developed a machine learning model for forecasting property prices. The dataset they used is maintained by the Florida authority, and the transactions between 2010 and 2019 were collected, comprising approximately 100000 records. Additionally, the economic trends, such as gross domestic product (GDP) and custom price index (CPI), were obtained and incorporated into the property transactions \cite{RN20}. Their dataset is superior to that of the current project since it contains more records and considers the local economics. A variety of machine learning algorithms, including logistic regression, random forest, voting classifier, and XGBoost were employed to solve the problem accurately. Consequently, they stated that the XGBoost offers the best performance. The results of their study can be referred to in the current project since they used data from the US, which shares some similarities with the UK.
\\
...
\begin{figure*}[!htbp]
	\centering
	\subfigure[Fold 0]{\includegraphics[width=5cm]{status_exclude_fold_0}}
	\hfill
	\subfigure[Fold 1]{\includegraphics[width=5cm]{status_exclude_fold_1}}
	\hfill
	\subfigure[Fold 2]{\includegraphics[width=5cm]{status_exclude_fold_2}}
	\hfil
	\subfigure[Fold 3]{\includegraphics[width=5cm]{status_exclude_fold_3}}
	\hfil
	\subfigure[Fold 4]{\includegraphics[width=5cm]{status_exclude_fold_4}}
	\caption{Training \& validation loss of basic model without prices (bias = 0)}
	\label{basic_status_exclude_0}
\end{figure*}

\begin{figure*}[!htbp]
	\centering
	\subfigure[Fold 0]{\includegraphics[width=5cm]{status_exclude_bias_005_fold_0}}
	\hfill
	\subfigure[Fold 1]{\includegraphics[width=5cm]{status_exclude_bias_005_fold_1}}
	\hfill
	\subfigure[Fold 2]{\includegraphics[width=5cm]{status_exclude_bias_005_fold_2}}
	\hfil
	\subfigure[Fold 3]{\includegraphics[width=5cm]{status_exclude_bias_005_fold_3}}
	\hfil
	\subfigure[Fold 4]{\includegraphics[width=5cm]{status_exclude_bias_005_fold_4}}
	\caption{Training \& validation loss of basic model without prices (bias = 0.05)}
	\label{basic_status_exclude_005}
\end{figure*}

\begin{figure*}[!htbp]
	\centering
	\subfigure[Fold 0]{\includegraphics[width=5cm]{status_exclude_bias_01_fold_0}}
	\hfill
	\subfigure[Fold 1]{\includegraphics[width=5cm]{status_exclude_bias_01_fold_1}}
	\hfill
	\subfigure[Fold 2]{\includegraphics[width=5cm]{status_exclude_bias_01_fold_2}}
	\hfil
	\subfigure[Fold 3]{\includegraphics[width=5cm]{status_exclude_bias_01_fold_3}}
	\hfil
	\subfigure[Fold 4]{\includegraphics[width=5cm]{status_exclude_bias_01_fold_4}}
	\caption{Training \& validation loss of basic model without prices (bias = 0.1)}
	\label{basic_status_exclude_01}
\end{figure*}

\begin{figure*}[!htbp]
	\centering
	\subfigure[Fold 0]{\includegraphics[width=5cm]{status_exclude_bias_015_fold_0}}
	\hfill
	\subfigure[Fold 1]{\includegraphics[width=5cm]{status_exclude_bias_015_fold_1}}
	\hfill
	\subfigure[Fold 2]{\includegraphics[width=5cm]{status_exclude_bias_015_fold_2}}
	\hfil
	\subfigure[Fold 3]{\includegraphics[width=5cm]{status_exclude_bias_015_fold_3}}
	\hfil
	\subfigure[Fold 4]{\includegraphics[width=5cm]{status_exclude_bias_015_fold_4}}
	\caption{Training \& validation loss of basic model without prices (bias = 0.15)}
	\label{basic_status_exclude_015}
\end{figure*}

\begin{figure*}[!htbp]
	\centering
	\subfigure[bias = 0]{\includegraphics[width=5cm]{cm_exclude_0}}
	\hfill
	\subfigure[bias = 0.05]{\includegraphics[width=5cm]{cm_exclude_005_0}}
	\hfill
	\subfigure[bias = 0.1]{\includegraphics[width=5cm]{cm_exclude_01_4}}
	\hfil
	\subfigure[bias = 0.15]{\includegraphics[width=5cm]{cm_exclude_015_4}}
