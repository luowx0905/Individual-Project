...
Figure \ref{status_dropout} demonstrates the effect of applying dropout. The overfitting is avoided, but the losses are oscillating around 0.7 with neither decreasing nor increasing trend. Despite these defects, the models have the lowest losses for predicting status. Therefore, they are evaluated. The confusion matrices are depicted in figure \ref{status_dropout_prediction}, and metrics are shown in table \ref{status_metrics_dropout}.
\\
...
The evaluation results show that the predictions are not accurate but superior than the linear regression models. 

\begin{figure*}[!htbp]
	\centering
	\subfigure[Fold 0]{\includegraphics[width=5cm]{cm_dropout0}}
	\hfill
	\subfigure[Fold 1]{\includegraphics[width=5cm]{cm_dropout1}}
	\hfill
	\subfigure[Fold 2]{\includegraphics[width=5cm]{cm_dropout2}}
	\hfil
	\subfigure[Fold 3]{\includegraphics[width=5cm]{cm_dropout3}}
	\hfil
	\subfigure[Fold 4]{\includegraphics[width=5cm]{cm_dropout4}}
	\caption{Confusion matrices for basic models (dropout inserted)}
	\label{status_dropout_prediction}
\end{figure*}

\begin{table}[!htbp]
	\centering
	\caption{Metrics of basic models (dropout inserted)}
	\label{status_metrics_dropout}
	\begin{tabular}{| c | c | c | c | c |}
		\hline
		Fold & Accuracy & Precision & Recall & F1 Score \\
		\hline
		0 & 0.6055 & 0.5432 & 0.8186 & 0.6529 \\
		\hline
		1 & 0.5211 & 0.3821 & 0.8267 & 0.5216 \\
		\hline
		2 & 0.7188 & 0.8113 & 0.7845 & 0.7977 \\
		\hline
		3 & 0.6367 & 0.5967 & 0.8228 & 0.6918 \\
		\hline
		4 & 0.63 & 0.6211 & 0.7925 & 0.6964 \\
		\hline
	\end{tabular}
\end{table}
