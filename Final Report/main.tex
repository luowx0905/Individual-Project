...
Table \ref{metrics_basic_model}, which summarizes the metrics for three models, shows that the MSE is decreasing and $R^2$ is increasing for the three models. Therefore, the results illustrate that the WRS could be a solution for the imbalanced dataset and that removing the outliers can improve the performance. 
\begin{table}[!htbp]
	\centering
	...
	\begin{tabular}{| l | c | c | c |}
		\hline
		 & MAE & MSE & $R^2$ \\
		 \hline
		 Basic model & 36538 & 4918700785 & 0.85 \\
		 \hline
		 WRS applied & 34099 & 4635616774 & 0.86 \\
		 \hline
		 Outliers removed & 35391 & 4580892828 & 0.87 \\
		 \hline
	\end{tabular}
\end{table}
