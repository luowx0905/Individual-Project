...
The predicted rental prices in table \ref{basic_model_prediction_price_ws} are not zero, but it should be noticed that one of the actual price is an outlier which has the potential to significantly impact the performance. Therefore, the all the outliers (true prices less than 100) are removed from the dataset and the model was retrained.
