...
The distinct advantage of this dataset is that it overcomes the limitation of the first two datasets, which are missing the COVID-19 data. However, its disadvantage is that the dataset is small. The COVID-19 cases between 28 January 2020 and 31 March 2020 were obtained, including 895 cases and 435 corresponding disclosure locations. Therefore, the accuracy of the results of training models with this dataset should be doubted. 

\subsection{Models}
\citet{RN17} have utilized decision tree, random forest, and linear regression models to predict the prices. For evaluation stage, the mean absolute error, mean squared error and median squared error were applied. As a result, the random forest has the best performance among three algorithms. The dataset used was the estate data in Riyadh, Saudi Arabia, the attriburtes of properties including location, area, type and price. 
