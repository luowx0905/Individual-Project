...
\subsubsection{Room Information Extraction}
...
Two HTML text snippets were utilized in this test and they are shonw in figure\ref{html_room_info_test_1} and figure \ref{html_room_info_test_2}.
\begin{figure*}[h]
	\centering
	\subfigure[Snippte 1]{\includegraphics[width=7.5cm, height=9cm]{html_room_info_1}\label{html_room_info_test_1}}
	\hfill
	\subfigure[Snippet 2]{\includegraphics[width=7.5cm]{html_room_info_2}\label{html_room_info_test_2}}
